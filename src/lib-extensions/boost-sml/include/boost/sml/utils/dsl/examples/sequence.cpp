 ...
 * @modified   Sunday, 26th June 2022 12:03:11 pm
 * @project    cpp-utils
 * @brief      Example of quasi-activity-diagram implementation of actions using UML state machine scheme implemented with boost::sml
 * 
