 ...
 * @modified Thursday, 3rd February 2022 11:46:26 am
 * @project  Winder
 * @brief
 *    
 *    Definitions of units, dimensions and quantities (based on the mp-units library) describing time values (extends 
 *    mp-units nemspaces)
 *    
