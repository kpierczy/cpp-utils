...
# @modified   Sunday, 26th June 2022 2:13:46 pm
# @project    cpp-utils
# @brief      This script should be sourced before starting work with the project. If the 'update' argument is passed to the script, 
